      ...
      <div className="footer-content">
        ...
        <div className="social-media">
          ...
          <ul>
            <li>
              <a
                href="https://www.facebook.com/agriinnovate"
                target="_blank"
            ...
            <li>
              <a
                href="https://twitter.com/agriinnovate"
                target="_blank"
                rel="noopener noreferrer"
              >
                Twitter
            ...
            <li>
              <a
                href="https://www.linkedin.com/company/agriinnovate"
                target="_blank"
                rel="noopener noreferrer"
              >
                LinkedIn
            ...
            <li>
              <a
                href="https://www.instagram.com/agriinnovate"
                target="_blank"
                rel="noopener noreferrer"
              >
                Instagram
            ...
            <li>
              <a
                href="https://www.youtube.com/agriinnovate"
                target="_blank"
                rel="noopener noreferrer"
              >
                YouTube
