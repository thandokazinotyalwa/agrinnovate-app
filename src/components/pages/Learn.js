...
const courses = [
  {
    ...
    videoUrl: "/video/intro-to-farming.mp4",
  ...
  },
  {
    ...
    videoUrl: "/video/advanced crop management.mp4",
    description: "Techniques for managing crops.",
  },
  {
    id: 3,
    category: "agricultural",
    title: "Sustainable Agriculture",
    videoUrl: "/video/sustainable agriculture.mp4",
    description: "Practices for sustainable farming.",
  },
  {
    id: 4,
    category: "agricultural",
    title: "Soil Health and Management",
    videoUrl: "/video/soil health.mp4",
    description: "How to maintain healthy soil.",
  },
  {
    id: 5,
    category: "agricultural",
    ...
    description: "Techniques for conserving water.",
  },
  {
    id: 6,
    category: "agricultural",
    ...
    videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4",
    description: "Strategies for managing pests.",
  },
  {
    id: 7,
    category: "business",
    ...
    videoUrl: "/video/sustainable agriculture.mp4",
    description: "Basics of agricultural business.",
  },
  {
    id: 8,
    category: "business",
    title: "Marketing Strategies for Farmers",
    videoUrl: "/video/sustainable agriculture.mp4",
    description: "Effective marketing strategies.",
  },
  {
    id: 9,
    category: "business",
    title: "Financial Management for Farms",
    videoUrl: "/video/sustainable agriculture.mp4",
    description: "Managing farm finances.",
  },
  {
    id: 10,
    category: "business",
    title: "Supply Chain Management in Agriculture",
    videoUrl: "/video/sustainable agriculture.mp4",
        ...
        <div className="sidebar">
          ...
          <ul>
            {filteredCourses.map((course) => (
              <li
                key={course.id}
                className={completedCourses.has(course.id) ? "completed" : ""}
              >
